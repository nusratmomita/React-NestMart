      ...
      <div className="drawer-side border-r border-[#e6e6e6]">
          ...
          <ul className="menu bg-white text-md min-h-full w-60 lg:w-60 p-4 flex flex-col justify-between [&>li>*]:border-none!"> 
            <div>
              ...
              <li className='-ml-15 mb-5 flex justify-center items-center gap-2 lg:mb-10 lg:mt-5'>
              ...
              <li className='border-none!'>
                  <NavLink to="/dashboard" className="hover:bg-transparent border-none! " end>
                      <LuLayoutDashboard className='text-[#6e708c] font-semibold text-xl' />
              ...
              <li className='mt-2'>
                  <NavLink to="/" className="hover:bg-transparent">
                      <FaHome className="dashboardNavLinks inline-block text-[#6e708c] font-semibold text-xl" />
                ...
                <div 
                  ...
                  >
                    <div className='flex items-center gap-2 '>
                      <FaRegUser className='text-[#6e708c] font-semibold text-xl'/>
                  ...
                  {openMenu === "auth" && (
                    <ul className='ml-6 mt-2 space-y-2'>
                      <li><NavLink className='text-[#6e708c] font-semibold hover:bg-transparent' to="/dashboard">Login</NavLink></li>
                      <li><NavLink className='text-[#6e708c] font-semibold hover:bg-transparent' to="/dashboard">Register</NavLink></li>
                    </ul>
                  )}
              </li>
              ...
              <li className='mt-2'>
                ...
                >
                  <div className='flex items-center gap-2 '>
                    <BiErrorAlt className='text-[#6e708c] font-semibold text-xl'/>
                ...
                {openMenu === "error" && (
                  <ul className='ml-6 mt-2 space-y-2'>
                    <li><NavLink className='text-[#6e708c] font-semibold hover:bg-transparent' to="/dashboard">404</NavLink></li>
                    <li><NavLink className='text-[#6e708c] font-semibold hover:bg-transparent' to="/dashboard">500</NavLink></li>
                  </ul>
                )}
              </li>
              ...
              <li className='mt-2'>
                ...
                >
                  <div className='flex items-center gap-2 group'>
                    <MdProductionQuantityLimits className='text-[#6e708c] font-semibold text-xl'/>
                ...
                {openMenu === "product" && (
                  <ul className='ml-6 mt-2 space-y-2'>
                    <li><NavLink className='text-[#6e708c] font-semibold hover:bg-transparent' to="/dashboard">All Products</NavLink></li>
                    <li><NavLink className='text-[#6e708c] font-semibold hover:bg-transparent' to="/dashboard">Add Product</NavLink></li>
                  </ul>
                )}
              </li>
              ...
              <li className='mt-2'>
                ...
                >
                  <div className='flex items-center gap-2 '>
                    <TbListDetails className='text-[#6e708c] font-semibold text-xl'/>
                ...
                {openMenu === "details" && (
                  <ul className='ml-6 mt-2 space-y-2'>
                    <li><NavLink to="/dashboard" className='text-[#6e708c] font-semibold hover:bg-transparent'>Details Page</NavLink></li>
                  </ul>
                )}
              </li>
              ...
              <li className='mt-2'>
                ...
                >
                  <div className='flex items-center gap-2 '>
                    <FaLuggageCart className='text-[#6e708c] font-semibold text-xl' />
                ...
                {openMenu === "cart" && (
                  <ul className='ml-6 mt-2 space-y-2'>
                    <li><NavLink to="/dashboard" className='text-[#6e708c] font-semibold hover:bg-transparent'>Cart</NavLink></li>
                  </ul>
                )}
              </li>
          </div>
