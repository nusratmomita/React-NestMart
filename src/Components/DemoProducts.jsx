...
const DemoProducts = () => {
  return (
    <div className='container'>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 quicksand-font px-10 md:px-5 lg:px-5 xl:px-5 2xl:px-0'>
            <div className='product_one pb-20 w-full rounded-[10px] mt-5 md:mt-10 lg:mt-10'>
                <h4 className='pt-20 pl-5 lg:pl-10 text-[24px] font-bold min-h-25 text-[#253D4E] lg:w-full xl:w-[70%]'>Everyday Fresh & Clean with Our Products</h4>
