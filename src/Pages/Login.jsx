                    ...
                    <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
                        ...
                        <div className="p-8 sm:p-10">
                            <div className="mb-8 text-center">
                                ...
                                <h1 className="text-4xl font-bold text-[#253D4E] mb-2">Welcome Back!</h1>
                            ...
                            <Formik initialValues={{
                                ...
                                onSubmit={(values , {setErrors}) => {
                                    const isUserValid = userCredentials.some((user) => user.email.toLowerCase() === values.email.toLowerCase() &&  user.name.toLowerCase() === values.name.toLowerCase());
